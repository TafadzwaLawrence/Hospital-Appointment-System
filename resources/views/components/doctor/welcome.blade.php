            ...
            <div class="flex items-center">
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Appointments</a>
                        <a href="" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Scheduled Appointments</a>
